...
<body>
	...
	*/
	...
	$AlanKodu		=	substr($Telefon, 0, 4);
	$BirinciBlok	=	substr($Telefon, 4, 3);
	$IkiniciBlok	=	substr($Telefon, 7, 2);
	$UcuncuBlok	=	substr($Telefon, 9, 2);
	
	echo $AlanKodu . " " . $BirinciBlok . " " . $IkiniciBlok . " " . $UcuncuBlok;
