...
<body>
	...
	*/
	...
	$Islem		=	str_pad($Metin, 20, "-", STR_PAD_BOTH);//Hem Sağına  hem soluna ekleyerek20 karakter olana kadar - koyar sonra yazdirir.
	
	
	echo $Islem;//her zaman sagdaki karakter sayisi daha fazladir
