...
<body>
	...
	*/
	...
	$Icerik			=	"Extra Eğitim - Sait Gülen - A'dan Z'ye PHP Görsel Eğitim Seti";
	
	echo $Icerik . "<br />";
	
	$Sonuc			=	str_word_count($Icerik, 0);//sifir yazarsak icerikteki harflaeri sayar
	
	echo $Sonuc . "<br /><br />";
	
	$IslemBir		=	str_word_count("Extra Eğitim - Sait Gülen - A'dan Z'ye PHP Görsel Eğitim Seti", 1); //1 koyduguuzda bunu dizi olarak algilar
	...
	$IslemIki		=	str_word_count("Extra Eğitim - Sait Gülen - A'dan Z'ye PHP Görsel Eğitim Seti", 2); // 2 oldugunda kelimelri sayiyor ikici kelimenin index numarasini anahtar yapiyor
