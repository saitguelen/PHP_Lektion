...
<body>
	...
	*/
	...
	echo "Kelime sayisi: ". $Sonuc . "<br /><br />";
	
	$IslemBir		=	str_word_count("Extra Eğitim - Sait Gülen - A'dan Z'ye PHP Görsel Eğitim Seti", 1, "ğĞüÜşŞıİöÖçÇ");
	...
	$IslemIki		=	str_word_count("Extra Eğitim - Sait Gülen - A'dan Z'ye PHP Görsel Eğitim Seti", 2, "ğĞüÜşŞıİöÖçÇ");
