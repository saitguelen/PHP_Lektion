...
<body>
	...
	*/
	echo "10 sn. sonra google'a yönlendirileceksiniz...";
	header("refresh:10; url=https://www.google.de"); //Direk yönlendirme yaptigi gibi, burada oldugu gibi 10 saniye refresh  yaptiktan sonra yönlendirme yapilir.
	exit();
