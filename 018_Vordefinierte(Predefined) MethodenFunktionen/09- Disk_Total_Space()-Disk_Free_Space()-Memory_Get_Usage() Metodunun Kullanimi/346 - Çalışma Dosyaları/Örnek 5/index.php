...
<body>
	...
	*/
	...
	$Deger	=	disk_free_space("E:"); // Bu kod sizde çalışmayabilir, çünkü benim cihazımda E diski var.
	
	echo "Server'ın (sunucunun) toplam boş / kullanılabilir disk kapasitesi : " . $Deger . " Byte";
