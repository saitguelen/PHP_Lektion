...
<body>
	...
	*/
	...
	$Deger	=	"Extra Eğitim-Sait Gülen-A'dan Z'ye PHP Görsel Eğitim Seti-A'dan Z'ye CSS3 Görsel Eğitim Seti-A'dan Z'ye Javascript Görsel Eğitim Seti";
	
	echo $Deger . "<br />";
	
	$Islem	=	strpbrk($Deger, "PHP");
