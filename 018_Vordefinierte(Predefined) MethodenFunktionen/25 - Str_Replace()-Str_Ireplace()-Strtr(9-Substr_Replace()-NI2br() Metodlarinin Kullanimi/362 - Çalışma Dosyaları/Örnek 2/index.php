...
<body>
	...
	*/
	...
	$Arananlar			=	array("Onur Tatlı", "Javascript","yazılımcısıyım.");
	$Degistirilecekler	=	array("Sait Gülen", "PHP","programcisiyim.");
	$Islem				=	str_replace($Arananlar, $Degistirilecekler, $Icerik, $Sayi);
