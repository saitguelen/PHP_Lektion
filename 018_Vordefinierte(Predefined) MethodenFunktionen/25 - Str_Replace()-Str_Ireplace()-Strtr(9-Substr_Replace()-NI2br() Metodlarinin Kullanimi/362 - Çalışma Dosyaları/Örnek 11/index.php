...
<body>
	...
	*/
	...
	$Icerik				=	"Sait Gülen bir PHP yazılımcısıdır.";//türkce karakterler iki karakter sayar
	
	echo $Icerik . "<br />";
	
	$Degisecek			=	array("Javascript programlama ve yazılım geliştirme uzmanıdır.");
	$Islem				=	substr_replace($Icerik, $Degisecek, -28);//sondan silmeye basla 28 karakter sil(bir PHP yazılımcısıdır.) ve yerine yenisin ekler
