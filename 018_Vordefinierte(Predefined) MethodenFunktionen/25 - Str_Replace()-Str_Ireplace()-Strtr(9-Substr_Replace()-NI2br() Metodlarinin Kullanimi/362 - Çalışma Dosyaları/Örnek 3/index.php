...
<body>
	...
	*/
	...
	$Arananlar			=	array("onur tatlı", "JavaScript");
	$Degistirilecekler	=	array("Sait Gülen", "PHP");
	$Islem				=	str_ireplace($Arananlar, $Degistirilecekler, $Icerik);//str_replace() buyuk kücük harf duyarliligi vardir bunu yok etmek icin str_ireplace() kullanilir
