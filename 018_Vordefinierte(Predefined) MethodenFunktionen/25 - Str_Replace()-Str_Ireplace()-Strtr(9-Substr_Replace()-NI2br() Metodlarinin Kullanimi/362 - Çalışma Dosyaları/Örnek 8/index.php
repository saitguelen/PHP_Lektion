...
<body>
	...
	*/
	...
	$Icerik				=	"Onur Tatlı bir Javascript yazılımcısıdır.";
	
	echo $Icerik . "<br />";
	
	$Degisecek			=	array("Sait Gülen");
	$Islem				=	substr_replace($Icerik, $Degisecek, 0, 11);//Sifirinci karakterden basla 11. karaktere kadar sil ve en basa Sait gülen ekler
