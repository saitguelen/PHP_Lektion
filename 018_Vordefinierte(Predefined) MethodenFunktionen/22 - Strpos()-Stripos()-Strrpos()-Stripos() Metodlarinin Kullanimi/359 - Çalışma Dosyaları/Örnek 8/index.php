...
<body>
	...
	mb_strpos()		:	Belirtilecek olan içerikte, belirtilecek olan herhangi bir değerin, 
						belirtilecek olan karakter kodlaması dahilinde gelişmiş olarak ilk eşleşme sonucundaki konumunu / sırasını bularak, bulduğu değeri geriye döndürür.
	stripos()		:	Belirtilecek olan içerikte, belirtilecek olan herhangi bir değerin büyük harf / küçük harf ayrımı olmaksızın ilk eşleşme sonucundaki 
						konumunu / sırasını bularak, bulduğu değeri geriye döndürür.
	mb_stripos()	:	Belirtilecek olan içerikte, belirtilecek olan herhangi bir değerin büyük harf / küçük harf ayrımı olmaksızın, belirtilecek olan karakter kodlaması 
						dahilinde gelişmiş olarak ilk eşleşme sonucundaki konumunu / sırasını bularak, bulduğu değeri geriye döndürür.
	...
	mb_strrpos()	:	Belirtilecek olan içerikte, belirtilecek olan herhangi bir değerin, belirtilecek olan karakter kodlaması dahilinde gelişmiş olarak son eşleşme sonucundaki 
						konumunu / sırasını bularak, bulduğu değeri geriye döndürür.
	strripos()		:	Belirtilecek olan içerikte, belirtilecek olan herhangi bir değerin büyük harf / küçük harf ayrımı olmaksızın son eşleşme sonucundaki 
						konumunu / sırasını bularak, bulduğu değeri geriye döndürür.
	mb_strripos()	:	Belirtilecek olan içerikte, belirtilecek olan herhangi bir değerin büyük harf / küçük harf ayrımı olmaksızın, belirtilecek olan karakter 
						kodlaması dahilinde gelişmiş olarak son eşleşme sonucundaki konumunu / sırasını bularak, bulduğu değeri geriye döndürür.
	*/
	
	$Metin	=	"PHP tüm web tabanlı programlama dilleri arasında en yaygın olarak kullanılan bir dildir. PHP yazılım dili çok üstün özelliklere sahiptir. Sait Gülen bir PHP yazılımcısıdır.";
	
	echo $Metin . "<br />";
	
	$Sonuc	=	stripos($Metin, "E"); //i takisi olanlarda büyük  kücük harf duyarliligi kalkar
