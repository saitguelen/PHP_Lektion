...
<body>
	...
	class Deneme{
		...
		public function __construct($HostBilgisi="localhost", $VeritabaniKullaniciAdi="Sait Gülen", $VeritabaniKullaniciSifresi="Volkan1980", $VeritabaniAdi="E-Ticaret"){
	...
	$Islem	=	new Deneme("8.8.4.4", "Gülen", "Parola", "Blog");
