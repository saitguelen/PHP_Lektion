...
<body>
	...
	*/
	...
	trait Kisi {
		...
		public $isim			=	"Sait";
		public const SOYISIM	=	"Alakent"; // Hata kodu döndürür, çünükü trait'ler tüm sınıf yapısının özelliklerine sahiptir fakat sadece const tanımı kullanılamaz.
	...
	?>
	<hr><br>
	<p>Hata kodu döndürür, çünükü trait'ler tüm sınıf yapısının özelliklerine sahiptir fakat sadece const tanımı kullanılamaz.</p>
</body>
</html>