	...
	*/
	...
	class Bir{
		...
		public function Bilgi(){
			$Metin	=	"İsim Soyisim : " . $this->Isim. " " . self::SOYISIM . "<br />A'dan Z'ye PHP Görsel Eğitim Seti";
			return $Metin;
		}
		//Burada diger türlü yaptigimiz nesnenin altina bunu yapmaliydik:
		//echo "İsim Soyisim : " . $Nesne->Isim . " " . Bir::SOYISIM . " " . $Nesne->Bilgi();
		//ama bununn yerine fonksiyona bu ismi kullan diyoruz
