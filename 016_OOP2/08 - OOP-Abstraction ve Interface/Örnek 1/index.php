...
<body>
	...
	*/
	...
	abstract class Deneme{
		...
		abstract public function Tanim($ParametreIcerigi); // Hata kodu döndürür, çünkü soyut sınıf içerisinde bulunan metodlar muhakkak soyut sınıfdan türeyen alt sınıflarda da bulunmalıdır.
