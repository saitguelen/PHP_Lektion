...
<body>
	...
	*/
	...
	class UstAlan extends Tema{ // Hata kodu döndürür, çünkü metotlar tanımlanmasına rağmen paremetreler eksik.
		
		public function HeaderAlani(){  // paremetreler eksik.
			
		}
		
		public function BodyAlani(){ // paremetreler eksik.
			
		}
		
		public function FooterAlani(){ // paremetreler eksik.
