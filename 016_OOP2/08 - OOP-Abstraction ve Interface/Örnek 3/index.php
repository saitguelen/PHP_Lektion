...
<body>
	...
	*/
	...
	abstract class Deneme{
		...
		abstract public function Tanim($ParametreIcerigi); // Hata kodu döndürür, çünkü soyut sınıf içerisinde bulunan metodlar muhakkak soyut sınıfdan türeyen tüm alt sınıflarda da bulunmalıdır.
		
	}
	
	class TestBir extends Deneme{
		public function Tanim($ParametreIcerigi){
  //abstract klass in functionu tanimlandi
		}
		
	}
	
	class TestIki extends Deneme{ // paremetreler eksik.Hata verir
