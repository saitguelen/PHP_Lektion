...
<body>
	...
	*/
    ...
    function Bilgiler()
    {
        ...
        echo "Meslek : " . $MeslekDegeri;

        echo "<br />";
        echo "<br />";
        echo "<hr />";
        $MailAdresi       =    func_get_arg(6);
        echo "Mail Adresi: " . $MailAdresi;
        echo "<br />";
        echo "<br />";
        echo "<hr />";
        $Cinsiyet = func_get_arg(5);
    ...
    Bilgiler("Volkan", "Alakent", "İstanbul", "Bilgisayar programlama ve yazılım geliştirme uzamanı", 38, "Erkek", "info@extraegitim.com", "https://www.extraegitim.com", "evli", "2 cocuk babasi");
