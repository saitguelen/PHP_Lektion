...
<body>
	...
	setcookie("KullaniciAdi", "Sait", $YasamSuresi);
	setcookie("KullaniciSoyadi", "Gülen", $YasamSuresi);
	...
	*/
	...
	setcookie("Kullanici[Adi]", "Sait", $YasamSuresi);
	setcookie("Kullanici[Soyadi]", "Gülen", $YasamSuresi);
	setcookie("Kullanici[EmailAdresi]", "info@phpegitim.com", $YasamSuresi);
