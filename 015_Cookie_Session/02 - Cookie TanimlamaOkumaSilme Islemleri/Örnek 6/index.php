...
<body>
	...
	*/
	...
	/*
	// Önce Bu alanı açıp aşağıdaki yazdıran alanları gizleyin, daha sonra bu alanı kapatıp aşağıdaki yazdıran alanları açıp kontrol edin.
	setcookie("KullaniciAdi", "Sait");
	setcookie("KullaniciSoyadi", "Gülen");
