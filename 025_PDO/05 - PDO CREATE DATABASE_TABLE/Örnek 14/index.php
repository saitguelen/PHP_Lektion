...
<body>
	...
	*/
	...
	$SorguA	=	$VeritabaniBaglantisi->exec("CREATE TABLE deneme.ornekyedek LIKE test.ornek");
		if($SorguA !== false){
			echo "Tablo Oluşturuldu.<br />";
			$SorguB	=	$VeritabaniBaglantisi->exec("INSERT INTO deneme.ornekyedek SELECT * FROM test.ornek");
				if($SorguB !== false){
