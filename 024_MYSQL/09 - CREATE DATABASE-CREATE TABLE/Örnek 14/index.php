...
<body>
	...
	*/
	...
	$Sorgu	=	$VeritabaniBaglantisi->query("CREATE TABLE eis_db.yenitablo LIKE extraegitim.uyeler");
		if($Sorgu){
			echo "Tablo Oluşturuldu<br />";
			$SorguIki	=	$VeritabaniBaglantisi->query("INSERT INTO eis_db.yenitablo SELECT * FROM extraegitim.uyeler");
				if($SorguIki){
