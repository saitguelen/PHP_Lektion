...
<body>
	...
	*/
	...
	$Sorgu	=	mysqli_query($VeritabaniBaglantisi, "CREATE TABLE eis_db.yenitablo LIKE extraegitim.uyeler");
		if($Sorgu){
			echo "Tablo Oluşturuldu<br />";
			$SorguIki	=	mysqli_query($VeritabaniBaglantisi, "INSERT INTO eis_db.yenitablo SELECT * FROM extraegitim.uyeler");
				if($SorguIki){
