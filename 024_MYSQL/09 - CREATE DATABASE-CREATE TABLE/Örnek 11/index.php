...
<body>
	...
	*/
	...
	$Sorgu	=	mysqli_query($VeritabaniBaglantisi, "CREATE TABLE yenitablo LIKE uyeler");
		if($Sorgu){
			echo "Tablo Oluşturuldu<br />";
			$SorguIki	=	mysqli_query($VeritabaniBaglantisi, "INSERT INTO yenitablo SELECT * FROM uyeler");
				if($SorguIki){
