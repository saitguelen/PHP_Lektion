...
<body>
	...
	*/
	...
	$Sorgu		=	mysqli_query($VeritabaniBaglantisi, "SELECT * FROM kisiler ORDER BY yas ASC, isim ASC"); //birden fazla deger siralayabiliriz, yas kücükten büyüge , isim A'dan Z#ye yas ayni isim de harf sirasi öce gelen öne yazilir
		if($Sorgu){
