...
<body>
	...
	*/
	...
	$VeritabaniBaglantisi	=	new mysqli("localhost", "root", "", "extraegitim"); //nesne yapisi ile kullanimi
	...
	$Sorgu		=	$VeritabaniBaglantisi->query("SELECT * FROM kisiler ORDER BY isim ASC LIMIT 2");
		if($Sorgu){
