...
<body>
	...
	*/
	...
	$Sorgu		=	mysqli_query($VeritabaniBaglantisi, "SELECT * FROM kisiler ORDER BY isim ASC LIMIT 2"); //ORDER BY ve LIMIT Birlikte kullanimi...isimleri a'dan z'ye sirala ve ilk iki deger getir
		if($Sorgu){
