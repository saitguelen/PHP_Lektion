...
<body>
	...
	*/
    ...
    $Ekle    =    mysqli_query($VeritabaniBaglantisi, "INSERT INTO uyeler (adisoyadi,e_mailadresi,sifre,telefon,yas,cinsiyet,sehir) values ('$Gelenadisoyadi', '$Gelenmail', '$Gelensifre', '$Gelentelefon','$Gelenyas','$Gelencinsiyet','$Gelensehir')");
    if ($Ekle) {
