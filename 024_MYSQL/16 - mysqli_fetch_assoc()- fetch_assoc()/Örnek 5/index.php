...
<body>
	...
	*/
	...
	$Sorgu	=	mysqli_query($VeritabaniBaglantisi, "SELECT ad AS KullaniciAdi, sinif AS OgrenciSinifi FROM ogrenciler");
		if($Sorgu){
			while($Kayit=mysqli_fetch_assoc($Sorgu)){
				echo "Kayıt İsim Değeri : " . $Kayit["KullaniciAdi"] . "<br />";
				echo "Kayıt Sinif Değeri : " . $Kayit["OgrenciSinifi"] . "<br /><br />";
			}
		}else{
			echo "Sorgu Hatası";
		}
