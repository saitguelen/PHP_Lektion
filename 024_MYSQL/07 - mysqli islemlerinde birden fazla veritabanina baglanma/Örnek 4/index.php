...
<body>
	...
	$VeritabaniBaglantisiBir		=	new mysqli("localhost", "root", "");
	...
	if($VeritabaniBaglantisiBir->connect_errno){
		...
		$VeritabaniBaglantisiBir->select_db("extraegitim");
	}
	
	$VeritabaniBaglantisiIki		=	new mysqli("localhost", "root", "");
	...
	if($VeritabaniBaglantisiIki->connect_errno){
		...
		$VeritabaniBaglantisiIki->select_db("filme");
	}
