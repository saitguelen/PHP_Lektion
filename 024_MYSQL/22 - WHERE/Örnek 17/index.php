...
<body>
	...
	*/
	...
	echo "beceri seviyelerinde '3-3-3' olanllari getir:  <br>";
	$Sorgu	=	mysqli_query($VeritabaniBaglantisi, "SELECT * FROM kisiler WHERE FIND_IN_SET ('\"3-3-3\"', beceriseviyeleri)");
		if($Sorgu){
